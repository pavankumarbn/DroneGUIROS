...
if __name__ == '__main__':
    ...
    rospy.Subscriber("/ground_truth/home/velab/catkin_ws1/src/ardrone_tutorials/src/drone_video_display.py/state", Odometry, odometryCallback)

...
(cl:defmethod cl:initialize-instance :after ((m <filter_state>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'filter_state)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tum_ardrone-msg:<filter_state> is deprecated: use tum_ardrone-msg:filter_state instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tum_ardrone-msg:header-val is deprecated.  Use tum_ardrone-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tum_ardrone-msg:x-val is deprecated.  Use tum_ardrone-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tum_ardrone-msg:y-val is deprecated.  Use tum_ardrone-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tum_ardrone-msg:z-val is deprecated.  Use tum_ardrone-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'dx-val :lambda-list '(m))
(cl:defmethod dx-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tum_ardrone-msg:dx-val is deprecated.  Use tum_ardrone-msg:dx instead.")
  (dx m))

(cl:ensure-generic-function 'dy-val :lambda-list '(m))
(cl:defmethod dy-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tum_ardrone-msg:dy-val is deprecated.  Use tum_ardrone-msg:dy instead.")
  (dy m))

(cl:ensure-generic-function 'dz-val :lambda-list '(m))
(cl:defmethod dz-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tum_ardrone-msg:dz-val is deprecated.  Use tum_ardrone-msg:dz instead.")
  (dz m))

(cl:ensure-generic-function 'roll-val :lambda-list '(m))
(cl:defmethod roll-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tum_ardrone-msg:roll-val is deprecated.  Use tum_ardrone-msg:roll instead.")
  (roll m))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tum_ardrone-msg:pitch-val is deprecated.  Use tum_ardrone-msg:pitch instead.")
  (pitch m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tum_ardrone-msg:yaw-val is deprecated.  Use tum_ardrone-msg:yaw instead.")
  (yaw m))

(cl:ensure-generic-function 'dyaw-val :lambda-list '(m))
(cl:defmethod dyaw-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tum_ardrone-msg:dyaw-val is deprecated.  Use tum_ardrone-msg:dyaw instead.")
  (dyaw m))

(cl:ensure-generic-function 'scale-val :lambda-list '(m))
(cl:defmethod scale-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tum_ardrone-msg:scale-val is deprecated.  Use tum_ardrone-msg:scale instead.")
  (scale m))

(cl:ensure-generic-function 'ptamState-val :lambda-list '(m))
(cl:defmethod ptamState-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tum_ardrone-msg:ptamState-val is deprecated.  Use tum_ardrone-msg:ptamState instead.")
  (ptamState m))

(cl:ensure-generic-function 'scaleAccuracy-val :lambda-list '(m))
(cl:defmethod scaleAccuracy-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tum_ardrone-msg:scaleAccuracy-val is deprecated.  Use tum_ardrone-msg:scaleAccuracy instead.")
  (scaleAccuracy m))

(cl:ensure-generic-function 'droneState-val :lambda-list '(m))
(cl:defmethod droneState-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tum_ardrone-msg:droneState-val is deprecated.  Use tum_ardrone-msg:droneState instead.")
  (droneState m))

(cl:ensure-generic-function 'batteryPercent-val :lambda-list '(m))
(cl:defmethod batteryPercent-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tum_ardrone-msg:batteryPercent-val is deprecated.  Use tum_ardrone-msg:batteryPercent instead.")
  (batteryPercent m))

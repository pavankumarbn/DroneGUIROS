...
if("TRUE" STREQUAL "TRUE")
  set(qtros_SOURCE_PREFIX /home/velab/catkin_ws1/src/qtros)
  set(qtros_DEVEL_PREFIX /home/velab/catkin_ws1/devel)
  set(qtros_INSTALL_PREFIX "")
  set(qtros_PREFIX ${qtros_DEVEL_PREFIX})
else()
  set(qtros_SOURCE_PREFIX "")
  set(qtros_DEVEL_PREFIX "")
  set(qtros_INSTALL_PREFIX /home/velab/catkin_ws1/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'qtros' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'velab <velab@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'qtros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/velab/catkin_ws1/src/qtros/${idir}'.  Ask the maintainer 'velab <velab@gmail.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${qtros_dep}_FOUND)
      find_package(${qtros_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${qtros_dep} REQUIRED ${depend_list})
  endif()
